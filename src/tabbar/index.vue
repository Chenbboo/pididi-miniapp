...
// i-carbon-home i-carbon-book i-carbon-map i-carbon-star i-carbon-user i-carbon-favorite i-carbon-favorite-filled
...
<template>
  <view v-if="customTabbarEnable" class="h-50px pb-safe">
    <view class="border-and-fixed bg-[#0D0D0D]" @touchmove.stop.prevent>
